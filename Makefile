...
coverage: ## check code coverage quickly with the default Python
	coverage run --source bid_stalker setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/bid_stalker.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ bid_stalker
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pycodestyle --statistics bid_stalker tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes bid_stalker tests
